...
INCLUDE_PATH = -I../veins/src -I. -IMyAppLayer -Isimulations -Isimulations/results
...
depend:
	...
	$(Q)$(MAKEDEPEND) $(INCLUDE_PATH) -f Makefile -P\$$O/ -- $(MSG_CC_FILES) $(SM_CC_FILES)  ./*.cc MyAppLayer/*.cc simulations/*.cc simulations/results/*.cc
